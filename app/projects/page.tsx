...
export default function Projects() {
  return (
    <section className="container mx-auto p-8">
      <Link href={"/#projects"} className="relative group hover:text-primary transition-colors duration-200">
      ...
      <table className="border-collapse w-full mt-4 ">
        <thead className="text-center sticky top-0 z-10 border-b border-accent text-sm text-secondary-foreground backdrop-blur bg-accent/80">
          <tr>
        ...
        <tbody>
          {projects.map((project, index) => {
            return (
              <tr key={index} className="align-top border-b border-accent last:border-none even:bg-accent/40">
